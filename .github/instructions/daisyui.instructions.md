...
```html
<label for="my-drawer" class="drawer-button btn">Open/close drawer</label>
```
...
<div
  class="megamenu max-sm:megamenu-vertical {MODIFIER} border border-base-300 p-2"
  id="my-megamenu-1"
  popover
>
...
<div
  class="megamenu max-sm:megamenu-vertical megamenu-wide w-full border border-base-300 p-2"
  id="my-megamenu-2"
  popover
>
  <span class="megamenu-active"></span>
...
```html
<span class="font-title text-rotate text-7xl max-md:text-3xl">
...
```html
<span class="font-title text-rotate text-7xl leading-[2] max-md:text-3xl">
  <span class="justify-items-center">
    <span>DESIGN</span>
    <span>DEVELOP</span>
    <span>DEPLOY</span>
...
```html
<div class="{MODIFIER} tooltip" data-tip="Tooltip text">
